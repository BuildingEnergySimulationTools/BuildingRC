...
model Example_Pelec_R8C3G
  ...
  BuildingRC.Envelope.R8C3G r8c3g(Inf = 0.13, R_i = 0.03, S_gf = 328, S_hc = 984, S_walls = 848, S_windows = 328, T_init (displayUnit = "degC") = 292.77, U_gf = 0.4, U_wall = 0.4, U_win = 1.7, V_int = 3608) annotation(
...
// Structure gain
  r8c3g.P_wall = Solar_gain * solar_wall_fraction + heated_floor_ahu * pac_wall_fraction;
  r8c3g.P_in = Solar_gain * (1 - solar_wall_fraction) + heated_floor_ahu * (1 - pac_wall_fraction) + AHU_R1.Heat_to_building + AHU_R1.Heat_to_building + Boundaries.y[4] + aCH_Occupation.Power_to_building;
  connect(Boundaries.y[1], heat_pump.T_ext) annotation(
    Line(points = {{-68, 0}, {-60, 0}, {-60, -24}, {-10, -24}}, color = {0, 0, 127}));
  connect(Boundaries.y[1], r8c3g.Text) annotation(
    Line(points = {{-68, 0}, {8, 0}, {8, 17}, {45, 17}}, color = {0, 0, 127}));
  connect(r8c3g.Tin, heating_Cooling_SP.Sensor_in) annotation(
    Line(points = {{67, 10}, {72, 10}, {72, -92}, {-68, -92}, {-68, -60}, {-52, -60}}, color = {0, 0, 127}));
  ...
  connect(r8c3g.Tin, aCH_Occupation.Tin) annotation(
    Line(points = {{67, 10}, {90, 10}, {90, 50}, {26, 50}, {26, 68}, {46, 68}}, color = {0, 0, 127}));
