...
model Example_Pelec_HP
  ...
  Modelica.Blocks.Sources.CombiTimeTable Boundaries(columns = 2:10, fileName = "C:/Users/bdurandestebe/Documents/56_NEOIA/modelica/boundaries_cta.txt", tableName = "table1", tableOnFile = true) annotation(
...
// Structure gain
  ...
  r6c2.P_in = Solar_gain * (1 - solar_wall_fraction) + heated_floor_ahu * (1 - pac_wall_fraction) + AHU_Cross_flow.Heat_to_building + Boundaries.y[4];
